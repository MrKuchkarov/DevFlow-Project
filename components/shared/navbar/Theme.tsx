        ...
        <Menubar className='relative border-none bg-transparent shadow-none'>
            <MenubarMenu>
                <MenubarTrigger
                    ...
                    dark:bg-dark-200 dark:data-[state=open]:bg-dark-200'>
                    {mode === 'light' ? (
                        <Image
                ...
                <MenubarContent
                    className='absolute -right-12 mt-3 min-w-[120px] rounded border py-2 dark:border-dark-400 dark:bg-dark-300'>
                    {themes.map((item) => (
                        <MenubarItem
                            key={item.value}
